...
CATEGORY_CHANNELS: dict[str, tuple[ChannelSpec, ...]] = {
    ...
    names.ROTATIONS: (
        ...
        ChannelSpec(
            ...
            ChannelKind.TEXT,
            "Read-only active and upcoming seasonal, Manhunt, and event rotations.",
            access_roles=(names.AGENT, names.ROGUE_AGENT),
            bot_access=True,
            read_only=True,
        ),
        ChannelSpec(
            names.DARK_ZONE_ROTATIONS,
            ChannelKind.TEXT,
            "Read-only DZ type, occupying faction, targeted loot, and vendor stock by zone.",
            access_roles=(names.AGENT, names.ROGUE_AGENT),
            bot_access=True,
            read_only=True,
        ),
        ChannelSpec(
            names.VENDORS,
            ChannelKind.TEXT,
            "Read-only Cassie Mendoza, Danny Weaver, Countdown, and Clan vendor stock.",
            access_roles=(names.AGENT, names.ROGUE_AGENT),
            bot_access=True,
            read_only=True,
        ),
